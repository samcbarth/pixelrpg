(function () {
  ...
  class Player {
    ...
    draw(ctx, camera, timeSeconds) {
      ...
      ctx.fillRect(screenX + 5, screenY + 18, 8, 4);
      ...
      ctx.fillRect(screenX + 6, screenY + 6, 6, 5);
      ...
      ctx.fillRect(screenX + 8, screenY + 11, 2, 1);
      ctx.fillStyle = "#4f7cff";
      ctx.fillRect(screenX + 5, screenY + 12, 8, 5);
      ctx.fillStyle = "#6fa3ff";
      ctx.fillRect(screenX + 6, screenY + 12, 3, 2);

      // Arms.
      ctx.fillStyle = "#f1ceb0";
      ctx.fillRect(screenX + 3 + sway, screenY + 12, 2, 6);
      ctx.fillRect(screenX + 13 - sway, screenY + 12, 2, 6);

      // Pants and boots.
      ctx.fillStyle = "#253756";
      ctx.fillRect(screenX + 6, screenY + 17 + legOffset, 3, 4);
      ctx.fillRect(screenX + 10, screenY + 17 - legOffset, 3, 4);
      ctx.fillStyle = "#18243d";
      ctx.fillRect(screenX + 5, screenY + 20 + legOffset, 4, 2);
      ctx.fillRect(screenX + 10, screenY + 20 - legOffset, 4, 2);

      // Tiny backpack pixel.
      ctx.fillStyle = "#7fd7ff";
      ctx.fillRect(screenX + 13, screenY + 13, 2, 3);
    }
  }
